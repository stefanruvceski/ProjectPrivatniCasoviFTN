...
namespace WorkerRole1
{
    ...
    {
        ServiceHost sh;
        string name = "PrivateClassInputRequest";
        ...
        public PrivateClassService()
        {
            ...
            sh = new ServiceHost(typeof(PrivateClassProvider));

            sh.AddServiceEndpoint(typeof(IPrivateClassContract), netTcpBinding, $"net.tcp://{endpoint.IPEndpoint}/{name}");
        }
